      ...
      <section className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mt-10">
          ...
          <ActionCard
            ...
            description="Connect Microsoft 365 sending, tracked links and reply handling."
            href="/automation"
          ...
          <ActionCard
            step="06"
            title="Plan social posts"
            description="Rotate weekly content themes and generate editable post drafts for your channels."
            href="/social"
